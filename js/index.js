...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://t.me/haidz2006', '_blank');
    });
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://github.com/haibedz', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Facebook');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.facebook.com/haibe206', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://zalo.me/0824117862', '_blank');
    });
});
...
console.log('%c- Có vẻ như bạn đang cố tình ăn cắp mã nguồn của tôi </ Haibedeveloper >.', 'color: #444; font-size: 25px; font-family: sans-serif;');
...
welcomeText.textContent = "Designed By NgDuy Developer";
